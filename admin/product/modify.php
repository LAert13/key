...
<form action="processProduct.php?action=modifyProduct&productId=<?php echo $productId; ?>" method="post" enctype="multipart/form-data" name="frmAddProduct" id="frmAddProduct">
 <p align="center" class="formTitle">Изменить Товар</p>
...
?>
    <br>
    <img src="/<?php echo PRODUCT_IMAGE_DIR . $pd_thumbnail; ?>"> &nbsp;&nbsp;<a href="javascript:deleteImage(<?php echo $productId; ?>);">Удалить
    Изображение</a> 
    <?php
	}
?>    
 ...
 <p align="center"> 
  <input name="btnModifyProduct" type="button" id="btnModifyProduct" value="Изменить Товар" onClick="checkAddProductForm();" class="box">
