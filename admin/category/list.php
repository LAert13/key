...
<form action="processCategory.php?action=addCategory" method="post"  name="frmListCategory" id="frmListCategory">
 <table width="100%" border="0" align="center" cellpadding="2" cellspacing="1" class="text">
  <tr align="center" id="listTableHeader"> 
   <td>Имя Категории</td>
   <td>Описание</td>
   <td width="75">Изображение</td>
   <td width="75">Изменить</td>
   <td width="75">Удалить</td>
  </tr>
  <?php
$cat_parent_id = 0;
...
?>
  <tr class="<?php echo $class; ?>"> 
   ...
   <td width="75" align="center"><a href="javascript:modifyCategory(<?php echo $cat_id; ?>);">Изменить</a></td>
   <td width="75" align="center"><a href="javascript:deleteCategory(<?php echo $cat_id; ?>);">Удалить</a></td>
  </tr>
  <?php
	} // end while
...
?>
  <tr> 
   <td colspan="5" align="center">Пока нет никаких Категорий</td>
  </tr>
  <?php
}
?>
