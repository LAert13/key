...
<tr> 
 ...
 <tr> 
  <td colspan="3"><div align="center"> 
    <input name="btnModify" type="submit" class="bluebox" id="btnModify" value="Отправить" onClick="return checkPassword();">
    &nbsp;&nbsp; 
    <input name="btnCancel" type="button" class="bluebox" id="btnCancel" onClick="window.location.href='listUser.php';" value="Отмена">
   </div></td>
 </tr>
 <tr>
  <td colspan="3">&nbsp;</td>
