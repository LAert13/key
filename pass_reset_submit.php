	...
	if(validateEmail($_POST['email']))
		{
			...
			$res = pass_recovery($_POST['email'],$site_url);
				...
				if($res == 3){
					die(msg(0,"Введенный адрес электронной почты не совпадает ни с одним адресом в базе данных. Пожалуйста <a href='register.php'>нажмите здесь</a> для регистрации."));
				}
				if($res == 99){
