            ...
            <form action="<?php echo $_SERVER['PHP_SELF']; ?>?step=2" method="post" name="frmCheckout" id="frmCheckout" onSubmit="return checkShippingAndPaymentInfo();">
                <table align="center" width="60%" cellspacing="1" cellpadding="1" border="0">
                  ...
                  <tr>
                    ...
                    <td><input onclick="this.value='';" class="form-control" name="name" id="name" type="text" size="25" maxlength="25" value="<?php if(!empty($_SESSION['name'])){ 
                                    echo $_SESSION['name']; } 
                              else { 
                  ...
                  <tr>
                    ...
                    <td><input onclick="this.value='';" class="form-control" name="phone" id="phone" type="text" size="25" maxlength="25" value="<?php if(!empty($_SESSION['phone'])){ 
                                        echo $_SESSION['phone']; } 
                                 else { 
                  ...
                  <tr>
                    ...
                    <td><input onclick="this.value='';" class="form-control" name="email" id="email" type="text" size="25" maxlength="25" value="<?php if(!empty($_SESSION['email'])){ 
                                        echo $_SESSION['email']; } 
                                 else { if (isset($getuser[0]['email'])){ echo $getuser[0]['email'];} } ?>"/></td>
                  </tr>
                  <tr>
                    <td><label for="city" style="margin-right: 5;">Город</label></td>
                    <td><input onclick="this.value='';" class="form-control" name="city" id="city" type="text" size="25" maxlength="25" value="<?php if(!empty($_SESSION['city'])){ 
                                        echo $_SESSION['city']; } 
                  ...
                  <tr>
                    ...
                    <td><input onclick="this.value='';" class="form-control" name="address" id="address" type="text" size="50" maxlength="100" value="<?php if(!empty($_SESSION['address'])){ 
                  ...
                  <tr>
                    <td>&nbsp;</td>
                    <td>
                        <input class="btn btn-primary btn-block" style="margin-top: 5;" type="submit" name="btnStep1" id="btnStep1" value="Далее" />
                    </td>
                  </tr>
                </table>
            </form>
